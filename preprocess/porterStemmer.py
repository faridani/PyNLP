...
def StemWord(inputWord):
	"""
	Stems a word
	the word needs to be a valid alpha string (meaning word.isalpha()==True)
	Note: we make them lower case in this one
	
	Examples:
	print StemWord("reincarnation")
	print StemWord("valid")
	print StemWord("Economy")
	print StemWord("Education")
	"""
	
	p = PorterStemmer()
	inputWord = inputWord.lower()
	return p.stem(inputWord, 0,len(inputWord)-1)
